...
1. Install. Run these commands in the repository root:
   uv tool install 'git+https://github.com/niksavis/basicly@v0.18.11#subdirectory=packages/basicly-tracker'
   uv tool install 'git+https://github.com/niksavis/basicly@v0.18.11#subdirectory=packages/basicly-board'
