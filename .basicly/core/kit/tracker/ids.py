...
The split this module exists to keep (`design/work-tracker.md` §9.4, basicly-vkh0.12),
...
Kit rules (`design/work-tracker.md` §4): **no basicly**, standard library only, no
...
def minted_ever(live: Iterable[str], tombstoned: Iterable[str] = ()) -> frozenset[str]:
    ...
    than removing anything (`design/work-tracker.md` §9.4).
    """
