...
| --- | --- | --- | --- |
| `.claude/CLAUDE.md` (claude) | 8776 | 9000 | 224 |
| `AGENTS.md` (codex) | 15674 | 16000 | 326 |
| `.github/copilot-instructions.md` (copilot) | 8875 | 9000 | 125 |
...
The 49 tiers hold 116 modules and group into 9 bands. Every band may import every band below
...
flowchart TB
  ...
  b2["2 · drivers — 7<br/>supervise · loop · release · usage_report"]
