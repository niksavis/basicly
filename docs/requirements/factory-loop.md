...
excluded from `DISPATCHABLE_STATUSES` (`loop_state.py`, with the exclusion
...
*decision quality* — a checkpoint answered in 5 s may be answered wrong, and `src/basicly/cli.py:2237` exists
