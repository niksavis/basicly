...
2. **The vendor's current documentation**, fetched now.
3. **The vendor's changelog**, which dates the change.
4. **The vendor's source or issue tracker**, where a documented feature that does not
   work gets contradicted.
5. **Third-party writing** — weakest, never sufficient alone.
