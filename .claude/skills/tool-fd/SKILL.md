---
name: tool-fd
description: Use fd or fd-find for fast filename and path discovery with sane defaults. Trigger when listing or enumerating files and directories by name or glob pattern, without complex find syntax.
---
