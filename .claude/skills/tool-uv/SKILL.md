---
name: tool-uv
description: Use uv for fast Python dependency sync, virtualenv and environment management, and command execution. Trigger for Python setup, install, lint, test, and script workflows in this repo.
---
