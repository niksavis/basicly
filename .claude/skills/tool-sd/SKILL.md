---
name: tool-sd
description: Use sd for fast, readable search-and-replace in files with safer defaults than sed. Trigger when swapping one string for another in a batch of files at once.
---
